...
$group2 = $option['comment-item-about-app-group'];
...
if (count($group2[0])>1) {
	?>
		...
		<?php 
  			$group = $option['app-about-page-group'];
  			$img = $group[0]['footer-img'];
			if ($img!='') {
				printf('<section class="comment-img-app">
						<div class="container">
							<div class="col-md-6 col-md-offset-3">
								<img src="%s" alt="footer-img">
							</div>
						</div>
					</section>', $img);
			}
