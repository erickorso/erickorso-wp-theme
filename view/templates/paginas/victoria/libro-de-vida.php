<?php 
global $option;
$group = $option['libro-about-group'];
if (count($group)>0) {
	?>
		    ...
		    <ul id="libro-de-vida">
		    	<?php
		    		foreach ($group as $item) {
						...
						if ($font!='') {
		    				$color_font = 'style="';
			    			$color_font .= 'color:'.$font.' !important;';
		    				$color_font .= '"';
		    			}else{
		    				$color_font .= 'color:white !important;';
		    			}
		    			if ($vertical!='') {
		    			...
		    			?>
				    		...
				    		<?php
				    			if ($align=='on') {
				    				?>
				    				<div class="col-md-6 item-caption wow-delay" <?php echo $bg_img?>>
										<?php 
					    			...
					    			<div class="col-md-6 item-img" <?php echo $vertical_style; ?>>
					    				<?php 
											if ($img!='') {
												printf('<div class="libro-image-in wow fadeInLeft">
